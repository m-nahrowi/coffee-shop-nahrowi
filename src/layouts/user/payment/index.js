    ...
    return (
        <>
            ...
            <div className="flex flex-col mt-3">
                ...
                <div className="flex flex-row justify-center absolute mx-32 my-32">
                    <div className="flex flex-col w-1/2">
                        ...
                        <div className="flex flex-col">
                            <div className="mx-24 border bg-white rounded-3xl shadow-2xl px-5">
                                <h1 className="text-black text-2xl text-center my-10 font-extrabold">
                                    Order Summary
                                </h1>
